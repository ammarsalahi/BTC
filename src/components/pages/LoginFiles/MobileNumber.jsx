...
export default function MobileNumber() {
    ...
    return (
        <div>
            <Box color="whtie">
            <MuiPhoneNumber label="Mobile number" variant="standard" color="dark" sx={{textcolor:"#000",height:'7ch', marginY:'1%'}} defaultCountry={'us'} fullWidth focused lable="Mobile number" inputProps={{
                style:{color:"black"}
            }}/>
